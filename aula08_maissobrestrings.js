...
console.log(umaString.charCodeAt(4)); //Retorna o código inteiro que representar o valor na tabela ASC
console.log(umaString.concat(' ', 'ei', ' ', 'sister')); //Raramente usado
console.log(umaString.indexOf('e', 0)); //Retorna o índice
console.log(umaString.lastIndexOf('e', umaString.length)); // Retorna o último índice
